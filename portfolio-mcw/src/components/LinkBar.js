...
const LinkBar = () => {
    return (
        <ul className="mt-8 flex items-center pl-0 list-none" aria-label="Socials-Links">
            ...
            <li className="mr-5 text-xs shrink-0">
                <a className="block hover:text-slate-200" href="https://codepen.io/marwebb" aria-label="CodePen (opens in a new tab)" target="_blank" rel="noreferrer noopener" title="CodePen">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-6 w-6" aria-hidden="true">
            ...
            <li className="mr-5 text-xs shrink-0">
                <a className="block hover:text-slate-200" href="https://dev.to/marywebby" aria-label="Devto (opens in a new tab)" target="_blank" rel="noreferrer noopener" title="Devto">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22" fill="white" className="h-6 w-6" aria-hidden="true">
